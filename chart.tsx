...
function ChartContainer({
  ...
  // Only apply aspect-video if no explicit height is set via className or inline style
...
function ChartTooltipContent({
  ...
  return (
    <div
      className={cn(
        "border-border/50 bg-background grid min-w-[8rem] items-start gap-1.5 rounded-[var(--radius-lg-ds)] border px-2.5 py-1.5 text-xs shadow-xl",
        className,
      )}
    >
